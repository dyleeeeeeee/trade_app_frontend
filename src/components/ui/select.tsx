...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-[320px] min-w-[8rem] overflow-hidden rounded-[10px] border border-hairline/[0.08] glass text-text-primary shadow-elevation-2 origin-top data-[state=open]:animate-menu-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
        position === "popper" &&
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn("px-3 py-1.5 text-caption font-semibold text-text-tertiary", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-hairline/[0.08]", className)} {...props} />
));
